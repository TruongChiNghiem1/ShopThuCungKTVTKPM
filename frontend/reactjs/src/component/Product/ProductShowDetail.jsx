                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="text-sm text-gray-500">
                            <span>|</span>
                            <span className="ml-2">261 Rating</span>
                            <span className="ml-2">|</span>
                            <span className="ml-2">463 Cumulative sales</span>
                        </div>
                    </div>
                                ...
                                <div className="border-b pb-4">
                                    <div className="flex items-start gap-3">
                                        <div className="w-10 h-10 rounded-full bg-gray-200 flex-shrink-0 overflow-hidden">
                                            <img src={'../../assets/default_avt.jpg'} alt="User" width={40} height={40} />
                                        </div>
                                        <div>
                                            ...
                                            <p className="text-sm mt-2">
                                                The shop sells quality products and delivers quite quickly. I bought it for the third time to try it out and it seems to be quite suitable. I will continue to support the shop in the future. After this article, I will buy more to change the dog's food.
                                            </p>
                                ...
                                <div className="border-b pb-4">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm mt-2">
                                                I often feed my baby this type of food and have bought it many times and found it suitable, easy to eat and never finished.
                                            </p>
                                            <div className="flex gap-2 mt-2">
                                                <img
                                                    src="https://images.unsplash.com/photo-1589924691995-400dc9ecc119?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60"
